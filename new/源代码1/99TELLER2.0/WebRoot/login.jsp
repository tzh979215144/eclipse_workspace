...
<table width="681" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:120px">
  <tr>
    <td width="353" height="259" align="center" valign="bottom" background="mages/login_1.gif"><table width="90%" border="0" cellspacing="3" cellpadding="0">
      <tr>
      ...
      <form id=form1 name=form1 onSubmit="javascript:return WebForm_OnSubmit();" action="login.do" method="post">
            <tr>
              <td height="50" colspan="2" align="left"><INPUT id=txt style="WIDTH: 130px" name="LOGIN_ID" value="${pageScope.login_no }" readonly type="hidden"></td>
						 ...
						 <tr>
              <td width="60" height="30" align="left">机 构 号</td>
			 ...
			 <tr>
              <td width="60" height="30" align="left">网 点 号</td>
          ...
          <tr>
              <td colspan="2" align="center"><input type="submit" name="btn" onclick='javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions("btn", "", true, "", "", false, false))' style="background:url(mages/login_5.gif) no-repeat" value=" 登  录  "> 
			  <input type="reset" name="Submit" style="background:url(mages/login_5.gif) no-repeat" value=" 取  消 "></td>
            <tr>
