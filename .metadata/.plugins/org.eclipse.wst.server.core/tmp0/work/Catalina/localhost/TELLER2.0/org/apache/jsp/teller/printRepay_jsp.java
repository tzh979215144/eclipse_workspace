 ...
 * Generated at: 2018-09-21 04:17:07 UTC
...
public final class printRepay_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(reMess != null){
	pageContext.setAttribute("reMess",reMess.getRecieveMess());
      ...
      out.write("\t\t//alert(1);\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction getRepayMess(){\r\n");
      out.write("\tvar dd_no =document.getElementById('DD_NO').value;\r\n");
      out.write("\tif(dd_no == null || dd_no ==''){\r\n");
      out.write("\t\talert('发放号不能为空');\r\n");
      out.write("\t\tmessRecieve();\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}\r\n");
      out.write("\tvar ajax = new AjaxApi('getMessage.do', 'FAFANG='+dd_no,doxml,messSend);\r\n");
      out.write("\t //actionmessage中配置，页面传值，执行完成的js,先开始时执行的\r\n");
      out.write("\t \t ajax.send();\r\n");
      out.write("\t}\r\n");
      out.write("\t function doxml(xml){\r\n");
      out.write("\t\t   messRecieve();\t\r\n");
      out.write("\t var LOAN_NO = xml.getElementsByTagName('LOAN_NO')[0].text;\t\r\n");
      out.write("\t var DD_DATE = xml.getElementsByTagName('DD_DATE')[0].text;\r\n");
      out.write("\t var DD_AMT = xml.getElementsByTagName('DD_AMT')[0].text;\r\n");
      out.write("\t var INT_RATE = xml.getElementsByTagName('INT_RATE')[0].text;\r\n");
      out.write("\t \r\n");
      out.write("\t document.getElementById('LOAN_NO').value = LOAN_NO;\r\n");
      out.write("\t document.getElementById('DD_DATE').value = DD_DATE;\r\n");
      out.write("\t document.getElementById('DD_AMT').value = DD_AMT;\r\n");
      ...
      out.write(");\">\r\n");
      out.write(" <form name=\"form1\" method=\"POST\" action=\"rePay.do\" >\r\n");
      ...
      out.write("      <tr>\r\n");
      out.write("        <td height=\"31\"><div class=\"titlebt\">还款计划</div></td>\r\n");
      out.write("      </tr>\r\n");
      out.write("    </table></td>\r\n");
      ...
      out.write("          <tr>\r\n");
      out.write("            <td class=\"left_txt\">当前位置：还款计划</td>\r\n");
      out.write("          </tr>\r\n");
      out.write("          <tr>\r\n");
      ...
      out.write("              <tr>\r\n");
      out.write("                <td class=\"left_bt2\">&nbsp;&nbsp;&nbsp;&nbsp;还款详细计划页面</td>\r\n");
      out.write("              </tr>\r\n");
      out.write("            </table>\r\n");
      out.write("            </td>\r\n");
      out.write("          </tr>\r\n");
      ...
      out.write("             <tr>\r\n");
      out.write("\t\t\t  \t<td height=\"30\" align=\"left\" class=\"left_txt2\">贷款号：<input type=\"text\" id=\"LOAN_NO\" name=\"LOAN_NO\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope.repayBean.LOAN_NO}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\"/></td>\r\n");
      out.write("               \t<td height=\"30\" align=\"center\" class=\"left_txt2\">发放号：<input type=\"text\" id=\"DD_NO\" name=\"DD_NO\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope.repayBean.DD_NO}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\"/></td>\r\n");
      out.write("               </tr>\r\n");
      out.write("              <tr>\r\n");
      out.write("              \t<td height=\"30\" align=\"left\" class=\"left_txt2\"><input type=\"button\" value=\"查询\" onclick=\"getRepayMess()\"/></td>\r\n");
      out.write("              </tr>\r\n");
      out.write("\t\t\t  <tr>\r\n");
      out.write("                <td height=\"30\" align=\"left\" class=\"left_txt2\">还款日：<input type=\"text\" name=\"PRI_REPAY_DAY\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope.repayBean.PRI_REPAY_DAY}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\"/></td>\r\n");
      out.write("               \t<td height=\"30\" align=\"center\" class=\"left_txt2\">发放日期：<input type=\"text\" name=\"DD_DATE\" ID=\"DD_DATE\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope.repayBean.DD_DATE}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\"/></td>\r\n");
      out.write("               </tr>\r\n");
      out.write("              <tr>\r\n");
      out.write("                  <td height=\"30\" align=\"left\" class=\"left_txt2\">还款日期：<input name=\"REPAY_DATE\"  type=\"text\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope.repayBean.REPAY_DATE}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\"/></td>\r\n");
      out.write("                  <td height=\"30\" align=\"center\" class=\"left_txt2\">到期日期：<input name=\"END_DATE\"  type=\"text\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope.repayBean.END_DATE }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\"/></td>\r\n");
      out.write("              </tr>\t\r\n");
      out.write("              <tr>\r\n");
      out.write("              \t<td height=\"30\" align=\"left\" class=\"left_txt2\">还款周期：<input type=\"text\" name=\"PRI_REPAY_FREQ\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope.repayBean.PRI_REPAY_FREQ}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\"\"/></td>\r\n");
      out.write("                <td height=\"30\" align=\"center\" class=\"left_txt2\">交易日期：<input name=\"TRAN_DATE\" type=\"text\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope.repayBean.TRAN_DATE }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\"/></td>\r\n");
      out.write("              </tr>\r\n");
      out.write("               <tr>\r\n");
      out.write("              \t<td height=\"30\" align=\"left\" class=\"left_txt2\">发放金额：<input type=\"text\" name=\"DD_AMT\" id=\"DD_AMT\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope.repayBean.DD_AMT}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\"\"/></td>\r\n");
      out.write("                <td height=\"30\" align=\"center\" class=\"left_txt2\">实际利率：<input name=\"INT_RATE\" id=\"INT_RATE\" type=\"text\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope.repayBean.INT_RATE }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\"/></td>\r\n");
      out.write("              </tr>\r\n");
      out.write("        </table>\r\n");
      out.write("        <table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n");
