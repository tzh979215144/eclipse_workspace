...
function AjaxApi(){
    ...
    <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">回收结算</div></td>
      </tr>
    </table>
			...
			<table class="left_txt2" cellspacing="1" cellpadding="2" width="99%"
				...
				<tbody>
					<tr>
						<td width="10%" height="35" align="center" class="left_txt2">
							账户类型
						</td>
					...
					<tr>
						<td height="35" align="center" class="left_txt2">
							<select name="select8">
								<option>
									1 活期
								</option>
			...
			<table width="99%" height="50" border="0" align="center"
				...
				<tbody>
					<tr>
						...
						<td width="7%" height="35" align="center" class="left_txt2">
							&quot;
						</td>
