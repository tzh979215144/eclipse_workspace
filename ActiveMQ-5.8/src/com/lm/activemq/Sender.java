...
public class Sender {  
    ...
    public static void init(String mes) {  
    ...
    public static void sendMessage(Session session, MessageProducer producer,String mes)  
            throws Exception {  
//        for (int i = 1; i <= SEND_NUMBER; i++) {}  
    ...
    public static void sendOaa(String mes) {
    	init(mes);
    }
    public static void main(String[] args) {
		sendOaa("开户人：小张\t开户账号：56465\t开户类型：活期");
	}
