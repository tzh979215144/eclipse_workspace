...
/**
 * 从session中拿购物车，属性为loginBean：session.getAttribute("loginBean")
 * 对购物车进行遍历，对数据库
 */
            ...
            for (int i = 0,m=car.size(); i < m; i++)
            {
                    ...
                    sqlOrder = "insert into orderForm(username,commodity_name,commodity_price,sum) values(?,?,?,?)";
                        ...
                        } catch (SQLException e)
                        {
                            ...
                            out.print(e+"<br>");
                            out.print("返回"+"");
                            out.print("<a href=/gouwuche/jsp/shoppingCar/lookShoppingCar.jsp>购物车</a>");
                            return;
                        }finally
                        {
...
//      ArrayList<Goods> goodsList = new ArrayList<Goods>();
    ...
    public void messShopping(HttpServletRequest request, HttpServletResponse response, String mess)
    {
        try
        {
            ...
            out.print("&nbsp;or&nbsp;");
            out.print("<a href=/gouwuche/lyons.dao/GoodsDao?key=3>查看订单</a></center>");
        } catch (IOException e)
        {
            e.printStackTrace();
        }
